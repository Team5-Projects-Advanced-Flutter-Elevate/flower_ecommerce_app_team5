...
class _TermsScreenState extends BaseStatefulWidgetState<TermsScreen> {
        ...
        builder: (context, state) {
          if (state is TermsLoading) {
            ...
            return ListView.builder(
              itemCount: state.data.termsAndConditions.length,
              itemBuilder: (context, index) {
                final item = state.data.termsAndConditions[index];
                return ListTile(
                  title: Text(
