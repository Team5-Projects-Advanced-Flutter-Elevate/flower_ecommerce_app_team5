...
import 'package:flower_ecommerce_app_team5/modules/home/ui/layouts/saved_address/domain/use_cases/saved_address/delete_address_use_case.dart';
  ...
  Future<void> _deleteAddressUseCase(AddressEntity address,String userId) async {
    ...
    switch (useCaseResult) {
      case Success<SavedAddressResponseEntity>():
        emit(DeleteAddressState(deleteAddressStatus: DeleteAddressStatus.success,updateAddress: useCaseResult.data));
      case Error<SavedAddressResponseEntity>():
        emit(DeleteAddressState(deleteAddressStatus: DeleteAddressStatus.error, error: useCaseResult.error));
    }
  }
}
