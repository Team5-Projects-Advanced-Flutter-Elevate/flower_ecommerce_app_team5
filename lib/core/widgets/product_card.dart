...
class ProductCard extends BaseStatelessWidget {
  ...
  final String price;
  final String? priceAfterDiscountIfExist;
  final void Function()? onAddToCartButtonClick;
  ProductCard(
      {super.key,
  ...
  String getPercentageOfDiscount() {
    if (priceAfterDiscountIfExist != null) {
      ...
      double? priceAfterDiscountDouble =
          double.tryParse(priceAfterDiscountIfExist!);
      if (priceDouble != null &&
          priceAfterDiscountDouble != null &&
          priceDouble > 0 &&
          priceAfterDiscountDouble > 0) {
        double percentage =
            ((priceDouble - priceAfterDiscountDouble) / priceDouble) * 100;
